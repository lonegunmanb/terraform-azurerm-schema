...
const azurermNetappVolumeGroupOracle = `{
  "block": {
    "attributes": {
      "account_name": {
...
func AzurermNetappVolumeGroupOracleSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(azurermNetappVolumeGroupOracle), &result)
	return &result
}
