...
const azurermEventgridEventSubscription = `{
  "block": {
    "attributes": {
...
func AzurermEventgridEventSubscriptionSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(azurermEventgridEventSubscription), &result)
	return &result
}
