...
const azurermArcKubernetesFluxConfiguration = `{
  "block": {
    "attributes": {
      "cluster_id": {
...
func AzurermArcKubernetesFluxConfigurationSchema() *tfjson.Schema {
	var result tfjson.Schema
	_ = json.Unmarshal([]byte(azurermArcKubernetesFluxConfiguration), &result)
	return &result
}
